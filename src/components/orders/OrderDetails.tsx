  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
      <div className="flex justify-between items-start mb-6">
        <h1 className="text-2xl font-bold">Детали заявки #{order.id.slice(-6)}</h1>
      ...
      <div className="space-y-6">
        <div className="border-b border-gray-200 pb-4">
          <h2 className="text-lg font-semibold mb-3">Информация об отправителе</h2>
        ...
        <div className="border-b border-gray-200 pb-4">
          <h2 className="text-lg font-semibold mb-3">Информация о получателе</h2>
          <dl className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <dt className="text-sm text-gray-500">Имя</dt>
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          <dl className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <dd className="text-base font-medium">{cargoTypeLabels[order.receiver.cargoType]}</dd>
            </div>
            <div>
              <dt className="text-sm text-gray-500">Вес</dt>
              <dd className="text-base font-medium">{order.receiver.weight} кг</dd>
            </div>
          </dl>
        </div>
        ...
        <div>
          ...
          <dl className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <dd className="text-base font-medium">{formatDate(order.createdAt)}</dd>
            </div>
            <div>
              <dt className="text-sm text-gray-500">ID заявки</dt>
              <dd className="text-base font-medium text-gray-600">{order.id}</dd>
            </div>
          </dl>
        </div>
      </div>
